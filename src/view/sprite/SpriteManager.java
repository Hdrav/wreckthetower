...
public class SpriteManager {
    ...
    private final static List <SpriteUnit>GAME_ACTORS = new ArrayList<>();
 
    /** A global single threaded list used to check collision against other
     * sprite objects.
     */
    private final static List<SpriteUnit> CHECK_COLLISION_LIST = new ArrayList<>();
    ...
    /** */
    public List<SpriteUnit> getAllSprites() {
        return GAME_ACTORS;
    }
     ...
     * @param sprites
     */
    public void addSprites(SpriteUnit... sprites) {
 ...
 /**
     ...
     */
    public List<SpriteUnit> getCollisionsToCheck() {
        return CHECK_COLLISION_LIST;
    }
