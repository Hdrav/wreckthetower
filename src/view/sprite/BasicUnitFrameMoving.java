...
public enum BasicUnitFrameMoving {
	...
	,GOLDEN_HEAVY_DYING("giant/golden_A_dying0",5)
	,IRON_MEDIUM_ARMO_DYING("iron_A_dying0",2);
	
	
	private  String path=new String("/animations/basic_player_animations/");
	private int numberOfFrame;
	private List<Image> animationList=new ArrayList<>();
	
	BasicUnitFrameMoving(String imageNameId,int numberOfFrame){
