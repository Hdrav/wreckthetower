...
public enum SpearUnitEnemyFrameMoving {
	...
	private  String path=new String("/animations/enemies_animation/lancer/");
	private int numberOfFrame;
	private List<Image> animationList=new ArrayList<>();
	
	SpearUnitEnemyFrameMoving(String imageNameId, int frame){
