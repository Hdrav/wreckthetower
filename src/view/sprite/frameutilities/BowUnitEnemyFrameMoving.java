...
public enum BowUnitEnemyFrameMoving {
	 ...
	 * */
	 ...
	 ,SHORT_BOW_GIANT_ATTACK("giant/short_bow_giant_arrow0",2)
	  ...
	  * 
	  * */
	 ,ARCHER_IRON_ARMOR_CHARGE("archer_arrow_iron_A0",2) 
	  ...
	  * 
	  * */
	 ,ARCHER_IRON_ARMOR_ATTACK("archer_arrow_iron_A0",2)
	...
	BowUnitEnemyFrameMoving(String imageNameId, int frame){
